          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input id="categoria" name="categoria" placeholder="Ex: Fornecedor, Aluguel, etc" disabled={createMutation.isPending} />
              </div>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          disabled={deleteMutation.isPending || pagarMutation.isPending}
                        >
